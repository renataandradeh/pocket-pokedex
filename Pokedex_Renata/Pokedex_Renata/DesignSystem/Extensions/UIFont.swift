...
extension UIFont {
    ...
    static let pageSubtitle = UIFont.systemFont(ofSize: 17, weight: .semibold)
    ...
    static let heartIcon = UIFont.systemFont(ofSize: 25, weight: .semibold)
    static let chevronRightIcon = UIFont.systemFont(ofSize: 48, weight: .semibold)
}
